    ...
    #---insert to stg.stagingObservations
        ...
        for counter in range(0,udataRange):
            if counter < udataRange-1:
                ...
                bflux = str(bdata.bFlux[i])
                j = str(counter + 1)
                observation = "SELECT "+id+","+j+",'"+name+"','"+startDate+"','"+endDate+"','"+utime+"','"+uflux+"','"+vtime+"','"+vflux+"','"+btime+"','"+bflux+"','new',1 UNION ALL "
                insert_observation = insert_observation + observation
            else:
                i = counter
                j = counter
                ...
                bflux = str(bdata.bFlux[i])
                j = str(counter + 1)
                observation = "SELECT "+id+","+j+",'"+name+"','"+startDate+"','"+endDate+"','"+utime+"','"+uflux+"','"+vtime+"','"+vflux+"','"+btime+"','"+bflux+"','new',1"
                insert_observation = insert_observation + observation
