...
forfiles /p "C:\Users\Przemek\Desktop\arqonia\frontend\app\outputFits" /s /m *.* /d -1 /c "cmd /c echo @path @fdate"
forfiles /p "C:\Users\Przemek\Desktop\arqonia\frontend\app\outputFits" /s /m *.* /d -1 /c "cmd /c echo del @path"
