...
;With cte
		...
		SELECT 9,
			   ...
			   N'rPhotometryTime',
			   N'rPhotometryTimeId',
			   N'bi.rPhotometryTime',
			   N'cast(rPhotometryTime as varchar)',
			   N'null',
			   N'inner join'
        UNION ALL
		SELECT 10,
			   ...
			   N'iPhotometryTime',
			   N'iPhotometryTimeId',
			   N'bi.iPhotometryTime',
			   N'cast(iPhotometryTime as varchar)',
			   N'null',
			   N'inner join'
			   )
